...
/** menu **/
	...
	$(document).ready(function() {
		...
		if($('.sf-menu').height() > 52 && $('body').width() > 991 && $('body').width() < 1200){	
			var menu_l = Math.floor(940/$('ul.sf-menu>li').length);			
			$('ul.sf-menu>li').css({width:menu_l});
			$('ul.sf-menu>li>a span').css({paddingLeft:'5%'});
			$('ul.sf-menu>li>a span').css({paddingRight:'5%'});
			}; 
		if( $('.sf-menu').height() > 52 && $('body').width() > 1199){
			var menu_l = Math.floor(1170/$('ul.sf-menu>li').length);			
			$('ul.sf-menu>li').css({width:menu_l});
			$('ul.sf-menu>li>a span').css({paddingLeft:'5%'});
			$('ul.sf-menu>li>a span').css({paddingRight:'5%'});
			}		
...
/** add icon aside li **/
    $(document).ready(function(){
       $('body').find('.box-category > ul > li > a').prepend('<i class="fa fa-chevron-right"></i>');
       $('aside').find('.box-content .afine li > a').prepend('<i class="fa fa-chevron-right "></i>');
       $('aside').find('.box-content .info li > a').prepend('<i class="fa fa-chevron-right "></i>');
       $('aside').find('.box-content .info-list li > a').prepend('<i class="fa fa-chevron-right "></i>');
       $('aside').find('.box-content .acount li > a').prepend('<i class="fa fa-chevron-right "></i>');
